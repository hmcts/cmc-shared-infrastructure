...
5. Manually add the `claim-issue-failure-email` secret with single email address; this is where alerts about claim issues failure will be sent.
6. Manually add the `document-management-failure-email` secret with single email address; this is where alerts about document management failure will be sent.
7. Manually add the `milo-report-failure-email` secret with single email address; this is where alerts about milo report failure will be sent.

8. Execute the project again.
